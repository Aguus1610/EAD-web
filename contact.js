  ...
  form.addEventListener('submit', async function(e) {
    ...
    try {
      ...
      const response = await emailjs.send(
        'service_tstfqsl', // ⚠️ REEMPLAZÁ esto con tu Service ID
        'template_ke1v1qj', // ⚠️ REEMPLAZÁ esto con tu Template ID
        {
          from_name: data.name,
        ...
        'SHCCKv__9-9XVNQDv' // ⚠️ REEMPLAZÁ esto con tu Public Key
      );
