...
(function() {
    ...
    const DOM = {
        ...
        init() {
            ...
            this.menu.toggle = document.querySelector('.nav-toggle');
            this.menu.container = document.querySelector('.site-nav');
    ...
    const NavigationController = {
        ...
        toggleMobileMenu() {
            DOM.menu.toggle.classList.toggle('open');
            DOM.menu.container.classList.toggle('open');
            document.body.classList.toggle('nav-open');
        },

        closeMobileMenu() {
            DOM.menu.toggle.classList.remove('open');
            DOM.menu.container.classList.remove('open');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Funcionalidad adicional del menú móvil
